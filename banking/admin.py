...
is_logged_in = False
is_admin = False  # Admin status, this can be set after login
...
def MENU():
    ...
    while True:
        print("\n====== BANK ACCOUNT MENU ======")
        print("0. Create Account (Admin Only)")
        print("1. Deposit Money")
        print("2. Withdraw Money")
        print("3. Check Balance")
        print("4. Transfer Money")
        ...
        if choice == "0":
            ...
            login_menu()  # Prompt to log in again
            break
        else:
            print("Invalid choice. Please select a number between 0 and 6.")

# Example placeholders for functions used in the menu
def created_account():
    print("Account created successfully!")

def deposit_money():
    print("Deposit money function called!")

def withdraw_money():
    print("Withdraw money function called!")

def check_balance():
    print("Check balance function called!")

def transfer_money():
    print("Transfer money function called!")

def transactions_history():
    print("Transaction history function called!")
